    ...
    return (
        <div className="About">
            ...
            <div className="About--Bio">
                ...
                <p>
                    Janae is currently working as an art therapist in pediatrics for those undergoing cancer treatment. She remains involved with Kids & Art Foundation, a nonprofit in the Bay Area bringing the arts to children fighting cancer and chronic illness. She is a member of the American Art Therapy Association as a current ATR credential holder #22-487.
                </p>
            </div>
        </div>
    )
